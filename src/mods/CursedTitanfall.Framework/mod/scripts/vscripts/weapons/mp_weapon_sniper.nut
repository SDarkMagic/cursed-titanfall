...
global function AddCallback_OnPrimaryAttackPlayer_weapon_sniper
...
struct {
    array< void functionref( entity, WeaponPrimaryAttackParams ) > onPrimaryAttackPlayerCallbacks_weapon_sniper
} file

void function AddCallback_OnPrimaryAttackPlayer_weapon_sniper( void functionref( entity, WeaponPrimaryAttackParams ) callback )
{
    Assert( !file.onPrimaryAttackPlayerCallbacks_weapon_sniper.contains( callback ), "Already added " + string( callbackFunc ) + " with AddCallback_OnPrimaryAttackPlayer_weapon_sniper"  )
	file.onPrimaryAttackPlayerCallbacks_weapon_sniper.append( callback )
}
//////////////////////////////////////
...
{
	foreach ( callback in file.onPrimaryAttackPlayerCallbacks_weapon_sniper )
	{
