...
{
	#if SERVER
		AddDamageCallbackSourceID( eDamageSourceId.mp_titanweapon_xo16_vanguard, xo16_DamagedTarget )
	#endif
	#if CLIENT
...
void function xo16_DamagedTarget( entity target, var damageInfo )
{
