...
global function AddCallback_OnWeaponPrimaryAttack_titanability_smoke
#if SERVER
...
struct
{
	...
	array< void functionref( entity, WeaponPrimaryAttackParams ) > onWeaponPrimaryAttackCallbacks_titanability_smoke
} file

// Cursed Titanfall callback stuff
void function AddCallback_OnWeaponPrimaryAttack_titanability_smoke( void functionref( entity, WeaponPrimaryAttackParams ) callback )
{
    Assert( !file.onWeaponPrimaryAttackCallbacks_titanability_smoke.contains( callback ), "Already added " + string( callback ) + " with AddCallback_OnWeaponPrimaryAttack_titanability_smoke"  )
	file.onWeaponPrimaryAttackCallbacks_titanability_smoke.append( callback )
}
//////////////////////////////////////
...
var function OnWeaponPrimaryAttack_titanability_smoke( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	...
	foreach( callback in file. onWeaponPrimaryAttackCallbacks_titanability_smoke )
	{
