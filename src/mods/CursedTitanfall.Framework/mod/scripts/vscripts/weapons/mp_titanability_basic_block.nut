...
global function AddCallback_OnWeaponActivate_titanability_basic_block
global function AddCallback_OnWeaponDeactivate_titanability_basic_block

// Cursed Titanfall callback stuff
void function AddCallback_OnWeaponActivate_titanability_basic_block( void functionref( entity ) callback )
{
    Assert( !file.onWeaponActivateCallbacks_titanability_basic_block.contains( callback ), "Already added " + string( callback ) + " with AddCallback_OnWeaponActivate_titanability_basic_block"  )
	file.onWeaponActivateCallbacks_titanability_basic_block.append( callback )
}

void function AddCallback_OnWeaponDeactivate_titanability_basic_block( void functionref( entity ) callback )
{
    Assert( !file.onWeaponDeactivateCallbacks_titanability_basic_block.contains( callback ), "Already added " + string( callback ) + " with AddCallback_OnWeaponDeactivate_titanability_basic_block"  )
	file.onWeaponDeactivateCallbacks_titanability_basic_block.append( callback )
}
//////////////////////////////////////
...
struct
{
	...
	array< void functionref( entity ) > onWeaponActivateCallbacks_titanability_basic_block
	array< void functionref( entity ) > onWeaponDeactivateCallbacks_titanability_basic_block
} file
...
void function OnActivate( entity weapon, int blockType )
{
	...
	StartShield( weapon )
	foreach( callback in file.onWeaponActivateCallbacks_titanability_basic_block )
	{
		callback( weapon )
	}
...
void function OnDeactivate( entity weapon, int blockType )
{
	...
	foreach( callback in file.onWeaponDeactivateCallbacks_titanability_basic_block )
	{
		callback( weapon )
	}
