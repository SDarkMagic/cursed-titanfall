...
global function AddCallback_OnStartZoomIn_titanweapon_predator_cannon
global function AddCallback_OnStartZoomOut_titanweapon_predator_cannon
...
struct {
    array< void functionref( entity ) > onStartZoomInCallbacks_titanweapon_predator_cannon
	array< void functionref( entity ) > onStartZoomOutCallbacks_titanweapon_predator_cannon
} file

void function AddCallback_OnStartZoomIn_titanweapon_predator_cannon( void functionref( entity ) callback )
{
    Assert( !file.onStartZoomInCallbacks_titanweapon_predator_cannon.contains( callback ), "Already added " + string( callbackFunc ) + " with AddCallback_OnStartZoomIn_titanweapon_predator_cannon" )
	file.onStartZoomInCallbacks_titanweapon_predator_cannon.append( callback )
}

void function AddCallback_OnStartZoomOut_titanweapon_predator_cannon( void functionref( entity ) callback )
{
    Assert( !file.onStartZoomOutCallbacks_titanweapon_predator_cannon.contains( callback ), "Already added " + string( callbackFunc ) + " with AddCallback_OnStartZoomOut_titanweapon_predator_cannon" )
	file.onStartZoomOutCallbacks_titanweapon_predator_cannon.append( callback )
}
//////////////////////////////////////
...
void function OnWeaponStartZoomIn_titanweapon_predator_cannon( entity weapon )
{
	...
	foreach ( callback in file.onStartZoomInCallbacks_titanweapon_predator_cannon )
	{
		callback( weapon )
	}
...
void function OnWeaponStartZoomOut_titanweapon_predator_cannon( entity weapon )
{
	...
	foreach ( callback in file.onStartZoomOutCallbacks_titanweapon_predator_cannon )
	{
		callback( weapon )
	}
