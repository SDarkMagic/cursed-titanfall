...
global function AddCallback_OnPrimaryAttack_titanability_power_shot
#if SERVER
...
struct {
    array< void functionref( entity, WeaponPrimaryAttackParams ) > onPrimaryAttackCallbacks_titanability_power_shot
} file

void function AddCallback_OnPrimaryAttack_titanability_power_shot( void functionref( entity, WeaponPrimaryAttackParams ) callback )
{
    Assert( !file.onPrimaryAttackCallbacks_titanability_power_shot.contains( callback ), "Already added " + string( callbackFunc ) + " with AddCallback_OnPrimaryAttack_titanability_power_shot" )
	file.onPrimaryAttackCallbacks_titanability_power_shot.append( callback )
}
//////////////////////////////////////
...
var function OnWeaponPrimaryAttack_power_shot( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	...
	foreach ( callback in file.onPrimaryAttackCallbacks_titanability_power_shot)
	{
